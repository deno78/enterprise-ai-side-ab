...
- **Why does `User` connect `auth.py` to `reservations.py`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `Facility` connect `app.py` to `reservations.py`, `facilities.py`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `Payment` connect `payments.py` to `reservations.py`?**
